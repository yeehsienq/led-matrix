...
void loop() {
  scroll_in(1,-14,message1);
  scroll_in(1,-15,message2);
  scroll_in(1,-13,message3);
  scroll_in(1,-13,message4);
  delay(UPDATE_DELAY_LONG);
  scroll_out(1,15,message1);
  scroll_out(1,16,message2);
  scroll_out(1,14,message3);
  scroll_out(1,14,message4);
  delay(UPDATE_DELAY_LONG);
}
